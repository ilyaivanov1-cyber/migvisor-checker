...
2. Base name: `checks/<trainee_name>/TASK-VAL-001_check_report.md`
...
Written to `checks/<trainee_name>/TASK-VAL-001_check_report.md` (or `_v2`, `_v3` … if prior reports exist):
