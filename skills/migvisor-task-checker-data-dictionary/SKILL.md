...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/docs/data-dictionary.md` |
| Reference file | `{reference_workspace}/module_5/codebase/docs/data_dictionary.md` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/data-dictionary/` |
