...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/input/product-scope.md` |
| Reference file | `{reference_workspace}/module_2/0 product-scope.md` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/scope/` |
...
2. Base name: `checks/<trainee_name>/scope/TASK-SCOPE-001_check_report.md`
...
Create the `checks/<trainee_name>/scope/` directory if it does not exist.
...
Written to `checks/<trainee_name>/scope/TASK-SCOPE-001_check_report.md` (or `_v2`, `_v3` … if prior reports exist):
