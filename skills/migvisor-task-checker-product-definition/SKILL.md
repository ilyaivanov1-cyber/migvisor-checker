...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/specifications/development_plan/product-definition.yaml` |
| Reference file | `{reference_workspace}/module_5/development_plan/product-definition.yaml` |
| Trainee name | basename of `{trainee_workspace}` (e.g. `Inventory_Stock_Project`) |
| Output dir | `{checks_dir}/{trainee_name}/definition/` |
