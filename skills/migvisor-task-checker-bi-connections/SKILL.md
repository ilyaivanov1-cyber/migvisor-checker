...
| Trainee file | `./Inventory_Stock_Project/products/Purchase/current/codebase/docs/bi/ (both .md files)` |
| Reference file | `C:/Users/IlyaIvanov1/Documents/migvisor_2.1.1_training/migVisor_workspace/Inventory_Stock_Project/products/Purchase/current/codebase/docs/bi/ (both .md files)` |
