...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/docs/bi/bi_connections.md` |
| Reference file | `{reference_workspace}/module_5/codebase/config/bi_connections.md` |
| Trainee name | basename of `{trainee_workspace}` (e.g. `Inventory_Stock_Project`) |
| Output dir | `{checks_dir}/{trainee_name}/bi-connections/` |
