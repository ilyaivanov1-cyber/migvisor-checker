...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/docs/go_live_checklist.md` |
| Reference file | `{reference_workspace}/module_5/codebase/docs/go_live_checklist.md` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/go-live/` |
