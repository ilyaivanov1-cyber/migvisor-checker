...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/specifications/to-be.md` |
| Reference file | `{reference_workspace}/module_4/to-be.md` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/to-be/` |
