...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/build-plan.md` |
| Reference file | `{reference_workspace}/module_5/codebase/build-plan.md` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/build-plan/` |
