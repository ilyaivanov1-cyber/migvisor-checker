...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/config/uc_setup.sql` |
| Reference file | `{reference_workspace}/module_5/codebase/config/uc_setup.sql` |
| Trainee name | basename of `{trainee_workspace}` (e.g. `Inventory_Stock_Project`) |
| Output dir | `{checks_dir}/{trainee_name}/uc-setup/` |
