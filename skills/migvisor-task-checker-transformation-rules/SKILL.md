...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/specifications/product-transformation-rules/product-transformation-rules.md` |
| Reference file | `{reference_workspace}/module_3/product-transformation-rules/product-transformation-rules.md` |
| Trainee name | basename of `{trainee_workspace}` (e.g. `Inventory_Stock_Project`) |
| Output dir | `{checks_dir}/{trainee_name}/transformation-rules/` |
