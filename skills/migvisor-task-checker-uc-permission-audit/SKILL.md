...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/config/uc_permission_audit.sql` |
| Reference file | `{reference_workspace}/module_5/codebase/config/uc_permission_audit.sql` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/uc-permission-audit/` |
