...
| | Path |
|---|---|
| Trainee file | `{trainee_workspace}/products/{product}/current/codebase/config/secrets_setup.md` |
| Reference file | `{reference_workspace}/module_5/codebase/config/secrets_setup.md` |
| Trainee name | folder name of `{trainee_workspace}` |
| Output dir | `{checks_dir}/{trainee_name}/secrets-setup/` |
